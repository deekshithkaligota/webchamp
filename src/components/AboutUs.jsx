...
const AboutUs = ({ navigateTo }) => {
    ...
    return (
        <>
            <SEO
                title="About Us | Webchamp.services"
                description="Learn about Webchamp - a digital agency helping local businesses in India grow online with web development and SEO."
                url="https://webchamp.services/about"
            />
